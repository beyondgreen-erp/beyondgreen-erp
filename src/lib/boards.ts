...
export const BUILTIN_BOARDS: Board[] = [
  ...
  { board_key: '/sales/quotations', label: 'Quotations', icon: 'ti-file-invoice', nav_group: 'Sales', href: '/sales/quotations', sort_order: 0 },
  { board_key: '/sales/costing', label: 'Quote Costing', icon: 'ti-calculator', nav_group: 'Sales', href: '/sales/costing', sort_order: 1 },
