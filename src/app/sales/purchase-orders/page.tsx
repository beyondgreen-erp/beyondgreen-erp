                          ...
                          <div className="flex-1 min-w-0 space-y-2.5">
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-5 gap-2.5">
                              ...
                              <div>
                                ...
                                <input readOnly title="Auto: Ordered − Received" value={numOf(it.qty_ordered) ? String(Math.max(0, numOf(it.qty_ordered) - numOf(it.total_received))) : (it.balance ?? '')} className={inp + ' text-right bg-gray-50'} />
                              </div>
                            </div>
                          </div>
