          ...
          <table className="w-full min-w-[600px] text-sm">
            ...
            <tbody>
              {filtered.map((v, i) => (
                ...
                >
                  <td className="px-5 py-3.5 text-white font-medium">{v.company_name}</td>
          ...
          <div className="flex items-center gap-3">
            {editing && (
              <button
                ...
                disabled={archiving}
                className="flex items-center gap-1.5 text-sm px-3 py-2.5 rounded-lg border border-gray-700 text-gray-400 hover:text-white hover:border-gray-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {archiving ? (
