              ...
              {loading ? (
                ...
                return (
                  <tr key={r.id} className="border-b border-[#F1F2F6] hover:bg-[#FAFBFF]">
                    ...
                    <td className="px-4 py-3">{s?.active_campaign ? <span className="text-xs font-semibold px-2 py-0.5 rounded-full" style={{ background: '#DBEAFE', color: '#1D4ED8' }}>Active</span> : <span className="text-gray-300 text-xs">\u2014</span>}</td>
