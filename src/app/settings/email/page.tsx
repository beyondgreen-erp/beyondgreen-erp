...
export default function EmailPage() {
  return (
    <div className="p-4 md:p-8 min-h-screen max-w-2xl mx-auto">
      ...
      <div className="bg-white border border-[#E4E6EE] rounded-xl p-8 flex flex-col items-center justify-center gap-3 text-center opacity-60">
        <svg className="w-10 h-10 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
        </svg>
        <p className="text-[#1A1D2E] font-semibold">Email Integration</p>
