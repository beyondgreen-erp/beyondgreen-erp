  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        ...
        {isIOS
          ? <p className="text-gray-400 text-[10px] mt-0.5">Tap <strong className="text-gray-300">Share</strong> then <strong className="text-gray-300">Add to Home Screen</strong></p>
      ...
      <button onClick={dismiss} className="shrink-0 p-1 text-gray-500 hover:text-gray-300">
